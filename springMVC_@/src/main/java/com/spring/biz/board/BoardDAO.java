...
public class BoardDAO {
	...
	private final String selectAll_Title="SELECT * FROM BOARD WHERE TITLE LIKE '%' || ? || '%' ORDER BY BID DESC "; // getAll
	private final String selectAll_Writer="SELECT * FROM BOARD WHERE WRITER LIKE '%' || ? || '%' ORDER BY BID DESC "; // getAll
